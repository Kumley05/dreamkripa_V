...
export const metadata: Metadata = {
  ...
  description: 'Learn about Sample Nav Business\'s 15+ year journey helping 50,000+ Indian students achieve their academic dreams. Expert counselors, proven results, and personalized guidance for higher education success.',
  ...
  openGraph: {
    title: 'About Sample Nav Business | 15+ Years of Excellence',
